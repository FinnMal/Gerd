  ...
  render() {
    ...
    return (
      <View style={{
        ...
        <View
          style={{
            backgroundColor: this.props.card_type == 'new_message'
              ? '#1e1e1e'
              : '#121212',
            padding: 25,
            borderRadius: 15
    ...
    return (
      <View style={{
        ...
        <TouchableOpacity
          ...
          <View
            style={{
              marginTop: this.props.editable
                ? 0
                : 20,
              marginRight: this.props.editable
                ? 0
                : 55,
              ...
              flexDirection: 'row',
              padding: 15,
              backgroundColor: this.props.editable
                ? '#1e1e1e'
                : '#121212',
              marginBottom: 0,
              borderRadius: 13
